...
public class RegisterrrActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.Register_content, new RegisterFragment())
                .addToBackStack(null)
                .commit();
    ...
    public void onRegisterFragmentInteraction(Account account) {
        ...
        StringBuilder url = new StringBuilder(getString(R.string.register_backend));
            ...
            try{
                ...
                if(resultObject.getBoolean("success") == true) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Registration is not possible: Reason: "
